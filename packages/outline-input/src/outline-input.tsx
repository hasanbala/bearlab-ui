...
import type { OutlineInputProps, IconType } from "./types/outline-input.types";
import styles from "./styles/outline-input.module.scss";
...
export const OutlineInput = (props: OutlineInputProps) => {
  const {
    name,
    label,
    error,
  ...
  const inputType = hasPassword && passwordVisible ? "text" : type;
    ...
    >
      ...
      >
        ...
        <input
          ...
          className={classnames(
            styles.input,
            beforeIcon && styles.inputWithBefore,
        ...
        {label && (
          <label
            ...
            className={classnames(
              ...
              beforeIcon && styles.labelWithBefore,
              className?.label
            )}
          >
